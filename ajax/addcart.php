                    ...
                    foreach($product_order as $k => $v) {?>
                        <tr>
                            <td><img src="<?=THUMBS.'/700x647x1/upload/product/'.$v['photo'] ?>" width="50"
                                    onerror = "this.src='thumbs/700x647x1/assets/images/noimage.png';" alt="<?=$v['tenvi'] ?>"></td>
...
<div class="modal-footer">
    <div class="text-right">
        <ul class="list-inline">
            <li><a class="btn _btngray" href="index" data-dismiss="modal">Tiếp tục mua hàng</a>
            </li>
