<div class="pagewrap">
    <div class="_box-content">
        ...
        <div class="row">
            <div class="col-xs-12 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                    ...
                    <div>
                        ...
                        <p><span style="font-family:Tahoma,Geneva,sans-serif;"><span style="font-size:14px;"><span
                                        style="line-height:1;"><img alt=""
                                            ...
                                            style="width: 30px; height: 30px;" />&nbsp;Hotline:
                                        <?=$optsetting['hotline'] ?>
            ...
            <div class="col-xs-12 wow fadeInRight" style="visibility: visible; animation-name: fadeInRight;">
                <form id="contact-form" action="lien-he" novalidate method="post" class="validation-contact">
                    <input type="hidden" name="_csrf-frontend"
                        value="_VvniyjUgjxzAC81tZAWZVtFFSWPCENM4mUM-A_1SQfKA7_oaYT4c0NrY3qFpi8UHQh0c-E8AiGwOmGdQbkMdQ==">
                    ...
                    <div class="form-group field-contactform-email required">
                        ...
                        <input type="text" id="contactform-email" class="form-control" name="email"
                        required>
                    ...
                    <div class="form-group field-contactform-phone required">
                        ...
                        <input type="text" id="contactform-phone" class="form-control" name="dienthoai"
                        required>
                        <div class="invalid-feedback">Vui lòng nhập vào số diện thoại.</div>
                        <p class="help-block help-block-error"></p>
                    </div>
                    <div class="form-group field-contactform-subject required">
                        <label class="control-label" for="contactform-subject">Tiêu đề</label>
                        <input type="text" id="contactform-subject" class="form-control" name="tieude"
                        required>
                    ...
                    <div class="form-group field-contactform-body required">
                        ...
                        <textarea id="contactform-body" class="form-control" name="noidung" rows="6"
                        required></textarea>
                    ...
                    <div class="form-group field-contactform-verifycode">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding-left-0">
                                <input type="text" id="contactform-verifycode" class="form-control" name="verifyCode"
                                    required>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit-contact"
                            onclick="check_captcha('<?=$cap ?>')">Submit</button>
                    </div>
