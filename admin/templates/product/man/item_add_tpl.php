        ...
        <div class="row">
		                        ...
		                        <div class="tab-content" id="custom-tabs-three-tabContent-lang">
		                            <?php foreach($config['website']['lang'] as $k => $v) { ?>
		                                <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
		                                    ...
		                                    <div class="form-group">
		                                        <label for="linkqr">Link qr (<?=$k?>):</label>
		                                        <input type="text" class="form-control for-seo" name="data[linkqr]" id="linkqr" placeholder="Link qr" value="<?=@$item['linkqr']?>" >
		                                    </div>
        	...
        	<div class="<?=$colRight?>">
				...
				<?php if(isset($config['product'][$type]['images1']) && $config['product'][$type]['images1'] == true) { ?>
			        <div class="card card-primary card-outline text-sm">
			            <div class="card-header">
			                <h3 class="card-title">Hình ảnh bước 2 <?=$config['product'][$type]['title_main']?></h3>
			                <div class="card-tools">
			                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
			                </div>
			            </div>
			            <div class="card-body">
	                    	<?php
	                    		$photoDetail = ($act != 'copy') ? UPLOAD_PRODUCT.@$item['photo1'] : '';
	                    		$dimension = "Width: ".$config['product'][$type]['width']." px - Height: ".$config['product'][$type]['height']." px (".$config['product'][$type]['img_type'].")";
				...
				<?php if(isset($config['product'][$type]['images2']) && $config['product'][$type]['images2'] == true) { ?>
			        <div class="card card-primary card-outline text-sm">
			            <div class="card-header">
			                <h3 class="card-title">Hình ảnh bước 2 hover <?=$config['product'][$type]['title_main']?></h3>
			                <div class="card-tools">
			                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
			                </div>
			            </div>
				...
				<?php if(isset($config['product'][$type]['images3']) && $config['product'][$type]['images3'] == true) { ?>
			        <div class="card card-primary card-outline text-sm">
			            <div class="card-header">
			                <h3 class="card-title">Hình ảnh bước 3 <?=$config['product'][$type]['title_main']?></h3>
			                <div class="card-tools">
			                	<button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
			                </div>
			            </div>
                ...
                <div class="row">
					...
					<?php if(isset($config['product'][$type]['soluong']) && $config['product'][$type]['soluong'] == true) { ?>
				    	<div class="form-group col-md-4">
	                        ...
	                        <div class="input-group">
	                        	<input type="text" class="form-control format-price gia_ban" name="data[soluong]" id="soluong" placeholder="Số lượng" readonly value="<?=@$item['soluong']?>">
	                        </div>
	                    </div>
				    <?php } ?>


					<?php if(isset($config['product'][$type]['soluongnhap']) && $config['product'][$type]['soluongnhap'] == true) { ?>
				    	<div class="form-group col-md-4">
	                        <label class="d-block" for="soluongnhap">Số lượng:</label>
	                        <div class="input-group">
	                        	<input type="text" class="form-control format-price gia_ban" name="data[soluongnhap]" id="soluongnhap" placeholder="Số lượng nhập (chỉ nhập khi nhập hàng vào kho)" value="" >
	                        </div>
	                    </div>
				    <?php } ?>
