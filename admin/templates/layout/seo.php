                    ...
                    <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-seolang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
                        ...
                        <div class="form-group">
                            <div class="label-seo">
                                ...
                                <strong class="count-seo"><span><?=strlen(utf8_decode(@$seoDB['description'.$k]))?></span>/320 ký tự</strong>
                            </div>
                            <textarea class="form-control check-seo description-seo" name="dataSeo[description<?=$k?>]" id="description<?=$k?>" maxlength="320" rows="5" placeholder="SEO Description (<?=$k?>)"><?=@$seoDB['description'.$k]?></textarea>
                        </div>
