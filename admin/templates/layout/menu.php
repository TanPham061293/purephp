            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                                ...
                                <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                                    ...
                                    <ul class="nav nav-treeview">
                                       ...
                                       <?php if(isset($v['coupon']) && $v['coupon'] == true) {
                                            ...
                                            <li class="nav-item <?=$none?>"><a class="nav-link <?=$active?>" href="index.php?com=product&act=man_coupon&type=<?=$k?>" title="Danh mục mã giảm giá"><i class="nav-icon text-sm far fa-caret-square-right"></i><p>Danh mục mã giảm giá</p></a></li>
                                        <?php } ?>
                ...
                <?php if(isset($config['news'])) { ?>
                    <?php foreach($config['news'] as $k => $v) { if(!isset($disabled['news'][$k])) { if(!empty($v['dropdown'])) { ?>
                        ...
                        ?>
                        <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                            <a class="nav-link <?=$active?>" href="index.php?com=news&act=man&type=tin-tuc" title="Quản lý <?=$v['title_main']?>">
                                <i class="nav-icon text-sm fas fa-book"></i>
                                <p>
                                    Tin tức - Sự kiện
                                </p>
                ...
                <?php if(isset($config['shownews']) && $config['shownews'] == true) { ?>
                    ...
                    ?>
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=news&act=man&type=dich-vu" title="Quản lý bài viết">
                ...
                <?php if(isset($config['statistical']['active']) && $config['statistical']['active'] == true) { ?>
                    <?php
                        $none = "";
                        $active = "";
                        if(isset($kiemtra) && $kiemtra == true) if($func->check_access('statistical', 'man', '', null, 'phrase-1')) $none = "d-none";
                        if($com=='statistical') $active = 'active';
                    ?>
                    <li class="nav-item <?=$active?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=statistical&act=man" title="Quản lý thống kê">
                            <i class="nav-icon text-sm fas fa-shopping-bag"></i>
                ...
                <?php if(isset($config['newsletter'])) { ?>
                    ...
                    ?>
                    <li class="nav-item has-treeview <?=$menuopen?> <?=$none?>">
                        <a class="nav-link <?=$active?>" href="index.php?com=newsletter&act=man&type=dangkybaogia" title="Quản lý nhận tin">
