		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<?php if(isset($config['setting']['pageindex']) && $config['setting']['pageindex'] == true) { ?>
						<div class="form-group col-md-4 col-sm-6">
							<label for="pageindex">Page index:</label>
							<input type="text" class="form-control" name="data[options][pageindex]" id="pageindex" placeholder="page index" value="<?=$options['pageindex']?>">
						</div>
					<?php } ?>
							...
							<?php foreach($config['website']['lang'] as $k => $v) { ?>
								...
								<div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
									<div class="form-group">
										...
										<input type="text" class="form-control for-seo" name="data[slogan<?=$k?>]" id="slogan<?=$k?>" placeholder="Slogan (<?=$k?>)" value="<?=@$item['slogan'.$k]?>" >
									</div>
								</div>
								...
								<div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
									<div class="form-group">
										...
										<input type="text" class="form-control for-seo" name="data[copyright<?=$k?>]" id="copyright<?=$k?>" placeholder="Copyright (<?=$k?>)" value="<?=@$item['copyright'.$k]?>" >
									</div>
								</div>


								<?php if(isset($config['setting']['title_desct1']) && $config['setting']['title_desct1'] == true) { ?>
									<div class="form-group">
										<label for="title_desct1">Tiêu đề sản phẩm trang chủ (<?=$k?>):</label>
										<input type="text" class="form-control for-seo" name="data[title_desct1<?=$k?>]" id="title_desct1<?=$k?>" placeholder="title_desct1 (<?=$k?>)" value="<?=@$item['title_desct1'.$k]?>" >
									</div>
								<?php } ?>

								<?php if(isset($config['setting']['title_desct2']) && $config['setting']['title_desct2'] == true) { ?>
									<div class="form-group">
										<label for="title_desct2">Tiêu đề tiêu chí (<?=$k?>):</label>
										<input type="text" class="form-control for-seo" name="data[title_desct2<?=$k?>]" id="title_desct2<?=$k?>" placeholder="title_desct2 (<?=$k?>)" value="<?=@$item['title_desct2'.$k]?>" >
									</div>
								<?php } ?>
