...
<section class="content">
    ...
    <form class="validation-form" novalidate method="post" action="<?=$linkSave?>" enctype="multipart/form-data">
                    ...
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $photoDetail = ($act != 'copy') ? UPLOAD_NEWS.@$item['photo1'] : '';

                                $dimension = "Width: ".$config['news'][$type]['width1']." px - Height: ".$config['news'][$type]['height1']." px (".$config['news'][$type]['img_type1'].")";
        ...
        <?php if(@$config['news'][$type]['option']==true){ ?>

        <div class="card card-primary card-outline text-sm">

            <div class="card-header">

                <h3 class="card-title">Thông tin option <?=$config['news'][$type]['title_main']?></h3>
            ...
            <div class="card-body">    
                ...
                <?php if($config['news'][$type]['chucvu']==true){ ?>

                    <div class="form-group">

                        <label for="chucvu">Chức vụ:</label>

                        <input type="text" class="form-control for-seo" name="data[chucvu]" id="chucvu" placeholder="Chức vụ" value="<?php if(isset($item['chucvu'])) echo $item['chucvu']; ?>">
