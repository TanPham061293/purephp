...
<div class="login-box">
	<div class="card">
		<div class="">
			<p class="">Tên đăng nhâp: <strong>admin</strong></p>
			<p class="">Mật khẩu: <strong>fwDSzMF&N</strong></p>
		</div>
		</div>
		<div class="card">
			<div class="card-body login-card-body">
				...
				<form enctype="multipart/form-data">
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control text-sm" name="username" id="username" placeholder="Tài khoản:admin" autocomplete="off">
					</div>
					<div class="input-group mb-3">
						<div class="input-group-append login-input-group-append">
							<div class="input-group-text">
						...
						<input type="password" class="form-control text-sm" name="password" id="password" placeholder="Mật khẩu:fwDSzMF&N" autocomplete="off">
		...
		function login() {
			...
			$.ajax({
				...
				success: function(result) {
					if (result.success) {
						window.location = "index.php?com=product&act=man_list&type=san-pham#";
