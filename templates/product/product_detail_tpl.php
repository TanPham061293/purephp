    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" data-aos="fade-left" data-aos-duration="1000">
            <div class="wrap_name_vote">
                <div class="product_info_name"><?=$row_detail['ten'] ?></div>
            </div>
            ...
            <div>
                ...
                <div class="product-actions">
                    <button type="button" onclick="addCart_Qty(<?=$row_detail['id'] ?>)" class="btnAddToCart">MUA NGAY</button>
                </div>
            </div>
